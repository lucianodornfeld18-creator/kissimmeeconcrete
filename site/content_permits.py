...
def hub():
    ...
    faqs = [
        ...
        faq("Do I need a license to pour concrete in Florida?", "No state license exists for concrete flatwork, pavers or stucco, and s. 489.117(4)(a) bars counties and cities from requiring a local license for driveway installation or decorative stone and paver work. Verify insurance, Sunbiz registration and references instead."),
